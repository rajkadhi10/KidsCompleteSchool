...
public class SliderAdapterColor extends PagerAdapter {

    private Context context;
    private LayoutInflater layoutInflater;

    SliderAdapterColor(Context context,String[] headings , int[] back_color){
    ...
    public Object instantiateItem(ViewGroup container,int postion){
        ...
        View view = layoutInflater.inflate(R.layout.slide_color,container,false);
